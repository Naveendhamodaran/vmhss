...
class EventManagetView extends StatefulWidget {
  const EventManagetView({super.key});

  @override
  State<EventManagetView> createState() => _EventManagetViewState();
}

class _EventManagetViewState extends State<EventManagetView> {
  ...
  final whatsappConroller = Get.put(WhatsappMessageController());
